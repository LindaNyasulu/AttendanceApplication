...
public class StudentAddapter extends RecyclerView.Adapter<StudentAddapter.StudentViewHolder> {
    ...
    public StudentAddapter(Context context, ArrayList<StudentItem> studentItems) {
